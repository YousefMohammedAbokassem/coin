      ...
      <div className="mt-6">
        <Listbox value={selected} onChange={setSelected}>
          <div className="relative">
            ...
            <Listbox.Options className="absolute z-10 mt-1 max-h-60 w-full text-left overflow-auto rounded-md  py-1 text-base shadow-lg ring-1 ring-black/5 focus:outline-none sm:text-sm">
              {people.map((person) => (
                <Listbox.Option
                  key={person.id}
                  value={person}
